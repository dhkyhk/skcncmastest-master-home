...
import skcnc.msa3.domain.repository.PrimaryDbioMapper;
import skcnc.msa3.domain.repository.SecondaryDbioMapper;
...
public abstract class AppCommonService {
    ...
    @Autowired
    protected PrimaryDbioMapper dbio;

    @Autowired
    protected SecondaryDbioMapper secDbio;
    ...
    protected <T> AppResponse<T> makeResponse(AppRequest<?> inData, T outData, String msgCd, Object...msgArgs) {
        var respCh = MapperUtil.convert(inData.getCh(), AppHeader.class);
